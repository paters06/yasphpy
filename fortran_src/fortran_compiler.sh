...
# Building and linking momentum_conservation with kernel_functions and pressure gradient
python3 -m numpy.f2py --overwrite-signature --quiet kernel_functions.f90 pressure_gradient.f90 momentum_conservation.f90 -m momentum_conservation -h momentum_conservation.pyf
python3 -m numpy.f2py -c --fcompiler=gnu95 momentum_conservation.pyf kernel_functions.f90 pressure_gradient.f90 momentum_conservation.f90
